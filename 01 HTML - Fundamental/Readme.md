...
## HTML Fundamental &mdash;

HTML ဆိုတာ Hypertext Markup Language တစ်ခုဖြစ်ပါတယ်။ web developer တွေက content တွေကို element တွေသုံးပြီး web page ပေါ်မှာ ဖော်ပြမို့အတွက် တည်ဆောက်ထားပါတယ်။ paragraph, link, heading, image and etc.

element တစ်ခုမှာ opening tag and closing tag ရရ် content ဆိုပီး အပိုင်းသုံးပိုင်းပါဝင်ပါတယ်
...
<!-- 
    <p>   -  Opeing Tag
    HTML is a markup language - Content
    </p>  -  Closing Tag
   -->
```
